	...
	<script src="static/js/jquery.Jcrop.js" defer></script>
	<script src="static/js/jcrop_bits.js" defer></script>
	<script src="static/js/jquery.visible.min.js" defer></script>
     <style type="text/css">
     	button{
     		border: none;
     		background: none;
	...
	<?php if ($curPageName == "messages_group.php" || $curPageName == "messages.php" ){}else{ ?>
			...
			<footer class="border-top py-3" style="background:#ccc">
			<section class="footer-grid">
				...
				<div id="c" class="item-footer" style="padding-left:15px">
					<span class="text-muted">Makati City, Philippines 1230</span>
					 <div class="pt-2 pb-2">
					 	<button class="button" data-sharer="facebook" data-title="Online Radio FM" data-url="https://www.tgnlife.com">
					   ...
					   <button class="button" data-sharer="pinterest" data-title="Online Radio FM" data-url="https://www.tgnlife.com">
					   ...
					   <button class="button" data-sharer="linkedin" data-title="Online Radio FM" data-url="https://www.tgnlife.com">
					   ...
					   <button class="button" data-sharer="twitter" data-title="Online Radio FM" data-url="https://www.tgnlife.com">
