   ...
   echo" <h1>This is from posts</h1>
      ...
      <thead>
        ...
        while($row=mysqli_fetch_assoc($get_deleted_query)){
            ...
            echo"<tr><td>$id</td><td >$body</td><td>$date</td><td>$image</td><td>$ageShow</td><td>$photoImage</td><td>$video</td><td>$video_display</td><td>$vidpost</td><td>$vidpost_display</td></tr>";
