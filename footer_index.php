<?php $curPageName = substr($_SERVER["SCRIPT_NAME"],strrpos($_SERVER["SCRIPT_NAME"],"/")+1);
      if ($curPageName == "messages_group.php" || $curPageName == "messages.php" ){}else{ ?>
			<footer class="py-3">
			<section class="footer-grid">
				<div class="item-footer" style="padding-left:15px">
					<span class="text-muted"> &copy 2021 TgnLife </span><br>
					<span class="text-muted pr-2"> Email: </span> <a class="text-decoration-none" href="https://www.tgnlife.com/contact" style="color:#007bff">Contact us</a><br>
					<span class="text-muted pr-2"> Chat: </span> <a class="text-decoration-none" href="https://www.tgnlife.com/tgnlifex/myapps/messaging/messages?u=support-service" style="color:#007bff">support service</a><br>
          <span class="text-muted pr-2"> Website: </span> <a class="text-decoration-none" href="https://www.tgnlife.com/" style="color:#007bff">www.tgnlife.com</a>
				</div>
  ...
  $(function(){
    ...
    $('.dropdown_data_window').on('scroll', msg_and_notif(user))
    bullet_slide(user)
    footer_orientation()
  });
